      ...
      <div className="bg-white dark:bg-gray-800 rounded-2xl w-full max-w-lg shadow-xl overflow-hidden border border-gray-100 dark:border-gray-700 animate-in fade-in zoom-in duration-200">
        ...
        <form onSubmit={handleSubmit} className="p-5 space-y-4">
          ...
          <div className="flex justify-end gap-3 pt-3 border-t border-gray-100 dark:border-gray-700">
            <Button type="button" variant="outline" onClick={onClose} className="hover:bg-thirdc hover:text-white duration-150 cursor-pointer dark:border-gray-600 dark:text-gray-200 dark:hover:bg-white dark:hover:text-thirdc hover:bg-thirdc hover:text-white">
              Cancel
            </Button>
