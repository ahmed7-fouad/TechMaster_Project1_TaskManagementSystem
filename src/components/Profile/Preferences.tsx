...
const Preferences = () => {
  ...
  return (
    <section className="flex flex-col gap-3 w-full h-full mt-6 ">
      ...
      <div className="w-full shadow-md rounded-lg p-6 border-2 mt-6 flex flex-col items-center gap-4 dark:bg-gray-800 dark:border-gray-600">

        <div className={`flex justify-between items-center border-b-2 pb-3 w-full ${isDarkMode ? "border-gray-700" : "border-[#e5e7eb]"}`}>
